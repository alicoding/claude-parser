...
class CacheCreation(BaseModel):
    ...
    ephemeral_5m_input_tokens: int = Field(0, alias="ephemeral_5m_input_tokens")
    ephemeral_1h_input_tokens: int = Field(0, alias="ephemeral_1h_input_tokens")


class ServerToolUse(BaseModel):
    """Server-side tool usage tracking."""
    
    web_search_requests: int = Field(0, alias="web_search_requests")

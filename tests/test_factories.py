...
class TestDefaults:
    ...
    def create_message_data(
        cls, message_type: str = "user", **overrides
    ) -> Dict[str, Any]:
...
class HookTestFactory:
    ...
    def create_type_guard_test(guard_function, valid_data, invalid_data):
        ...
        def test_function():
            ...
            # Test invalid data
            assert guard_function(invalid_data) is False, (
                "Guard should reject invalid data"
            )
...
class MessageTestFactory:
    ...
    def create_validation_test(
        validator_function, valid_samples: list, invalid_samples: list
    ):
    ...
    def create_filter_test(filter_type: str, expected_count: int):
        ...
        def test_function(conversation):
            ...
            assert len(results) == expected_count, (
                f"Expected {expected_count} {filter_type} messages"
            )
    ...
    def create_search_test(query: str, case_sensitive: bool, expected_matches: int):
        ...
        def test_function(conversation):
            ...
            assert len(results) == expected_matches, (
                f"Expected {expected_matches} matches for '{query}'"
            )

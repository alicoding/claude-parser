...
class TestCgStatus:
    ...
    def test_status_no_transcripts(self, mock_timeline_class, runner):
        ...
        assert '💡 Make sure you\'re in a directory that Claude Code has worked on' in result.stdout
...
class TestCgCheckout:
    ...
    def test_checkout_success(self, mock_timeline_class, runner, mock_timeline):
        ...
        mock_timeline.checkout_by_uuid.assert_called_with('def67890-1234-1234-1234-123456789def')
...
class TestCgUndo:
    ...
    def test_undo_steps(self, mock_timeline_class, runner, mock_timeline):
        ...
        mock_timeline.checkout_by_uuid.return_value = {
            'app.py': {'content': 'original content', 'timestamp': '2025-01-04T10:15:30Z'}
        }
...
class TestCgCommandIntegration:
    ...
    @patch('claude_parser.cg_cli.ClaudeCodeTimeline')
    def test_timeline_exception_handling(self, mock_timeline_class, runner, mock_timeline):

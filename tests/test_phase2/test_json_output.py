...
from claude_parser.hooks import json_output, advanced
...
class TestJsonOutput:
    ...
    def test_pretooluse_allow_format(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            ...
            assert data["hookSpecificOutput"]["permissionDecisionReason"] == "Test reason"
    ...
    def test_pretooluse_deny_format(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            ...
            assert data["hookSpecificOutput"]["permissionDecisionReason"] == "Security violation"
    ...
    def test_userpromptsubmit_with_context(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            ...
            assert "hookSpecificOutput" in data
            assert data["hookSpecificOutput"]["additionalContext"] == "Extra context here"
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            with pytest.raises(SystemExit):
                json_output(
                    ...
                    additional_context="Welcome message"
                )
...
class TestAdvancedHelpers:
    ...
    def test_advanced_allow(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            ...
            assert data["hookSpecificOutput"]["permissionDecision"] == "allow"
            assert data["hookSpecificOutput"]["permissionDecisionReason"] == "Custom approval reason"
    ...
    def test_advanced_allow_default_reason(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            ...
            assert data["hookSpecificOutput"]["permissionDecision"] == "allow"
            assert data["hookSpecificOutput"]["permissionDecisionReason"] == "Auto-approved"
    ...
    def test_advanced_deny(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            ...
            assert data["hookSpecificOutput"]["permissionDecision"] == "deny"
            assert data["hookSpecificOutput"]["permissionDecisionReason"] == "Security issue detected"
    ...
    def test_advanced_ask(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            ...
            assert data["hookSpecificOutput"]["permissionDecision"] == "ask"
            assert data["hookSpecificOutput"]["permissionDecisionReason"] == "Please confirm this action"
    
    def test_advanced_add_context_userprompt(self):
        """Test advanced.add_context() for UserPromptSubmit."""
        with patch('sys.stdout', new=StringIO()) as fake_out:
            with pytest.raises(SystemExit):
                advanced.add_context("Additional information", hook_type="UserPromptSubmit")
            
            output = fake_out.getvalue()
            data = orjson.loads(output)
            
            assert data["decision"] == "continue"
            assert data["hookSpecificOutput"]["additionalContext"] == "Additional information"

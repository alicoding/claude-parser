...
from claude_parser.models import AssistantMessage, MessageType, UserMessage
...
class TestRealDataValidation:
    ...
    def prod_files(self):
        ...
        prod_dir = (
            project_root
            / "jsonl-prod-data-for-test"
            / "-Volumes-AliDev-ai-projects-claude-parser"
        )
    ...
    def test_text_extraction_from_nested_structure(self, prod_files):
        ...
        for msg in conv.messages:
            if isinstance(msg, (UserMessage, AssistantMessage)):
                ...
                assert isinstance(text, str), "text_content must return string"
